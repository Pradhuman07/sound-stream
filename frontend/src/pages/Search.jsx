...
const Search = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-4 md:pb-34 pb-34 px-4">
        <div className="mb-6">
        ...
        <div className="grid gap-4 -mt-1">
          {filteredSongs.map((song, index) => (
            <div 
              key={index} 
              className="flex items-center bg-white rounded-lg p-4  md:mx-26 shadow-sm cursor-pointer"
        ...
        <div className="fixed bottom-14 md:bottom-14 left-0 right-0 bg-white border-t border-gray-300 py-2 px-4">
          <div className="flex items-center max-w-screen-xl mx-auto">
            ...
            <button onClick={() => dispatch(togglePlayPause())} className="p-2 cursor-pointer">
              {isPlaying ? (
                // Pause Icon (same as in Home.jsx)
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 9v6m4-6v6" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              ) : (
                // Play Icon (same as in Home.jsx)
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
