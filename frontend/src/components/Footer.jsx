      ...
      <div className="flex justify-between items-center max-w-screen-xl mx-auto">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" 
               stroke={location.pathname === '/' ? '#A5B4FC' : 'currentColor'}>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" 
               stroke={location.pathname === '/search' ? '#A5B4FC' : 'currentColor'}>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" 
               stroke={location.pathname === '/upload-music' ? '#A5B4FC' : 'currentColor'}>
