...
const Logo = () => {
    return (
        <div className="flex items-center gap-2 md:gap-2.5 cursor-pointer">
            <div className="w-7.5 h-7.5 lg:w-9 lg:h-9 bg-gradient-to-r from-blue-300 to-indigo-400  transform rotate-45 transition-transform hover:rotate-90 flex items-center justify-center rounded-full">
